...
def process_policies(session_id: str, file_paths: list[str]):
    ...
    build_policy_collection(collection_name=session_id, policy_documents=policy_documents)
    return {"status": "success"}

def review_contract(file_path: str, session_id: str, provider: str, model_name: str, api_key: str, top_k_policies: int = 4) -> dict:
    ...
    retrieval_data = run_retrieval_agent(intake_data, collection_name=session_id, top_k=top_k_policies)
